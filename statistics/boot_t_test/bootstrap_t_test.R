# Bootstrap t-test
# source https://rdrr.io/github/tpepler/nonpar/src/R/boot.t.test.R
# Algorithm 16.2, p224 Computation of the bootstrap test statistic for testing equality of means 
